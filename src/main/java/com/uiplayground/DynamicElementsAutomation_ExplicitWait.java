...
public class DynamicElementsAutomation_ExplicitWait {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		for (WebElement foodItem : foodItemList) {
			...
			//WebElement foodItemName = wait.until(ExpectedConditions.visibilityOfElementLocated(swiggyCardLocator));
			...
			//WebElement foodItemPrice = wait.until(ExpectedConditions.visibilityOfElementLocated(swiggyCardLocator));
